...
- This release includes:
  - Slackware package: **fish-4.8.1-x86_64-1_da.txz**
  - Built from upstream fish release: **fish-4.8.1-linux-x86_64.tar.xz**
...
1. Copy the package file to your USB disk - `/boot/extra/` for auto-install on boot.  
   ...
   ```sh
   wget -O /boot/extra/fish-4.8.1-x86_64-1_da.txz https://raw.githubusercontent.com/masterwishx/unraid-fish-shell/main/slackware/fish/fish-4.8.1-x86_64-1_da.txz && installpkg /boot/extra/fish-4.8.1-x86_64-1_da.txz
   ```
